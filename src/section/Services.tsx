...
const ServicesCard = ({
  ...
  return (
    <>
      <div
        className={`my-10 flex items-center justify-center ${reverse ? "md:flex-row-reverse" : "md:flex-row"} flex-col`}
      >
        ...
        >
          <h3 className="pb-4 leading-snug">{heading}</h3>
